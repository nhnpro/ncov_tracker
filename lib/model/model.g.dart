...
Serializer<TravelAlert> _$travelAlertSerializer = new _$TravelAlertSerializer();
...
class _$TravelAlertSerializer implements StructuredSerializer<TravelAlert> {
  @override
  final Iterable<Type> types = const [TravelAlert, _$TravelAlert];
  @override
  final String wireName = 'TravelAlert';

  @override
  Iterable<Object> serialize(Serializers serializers, TravelAlert object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'countryCode',
      ...
      serializers.serialize(object.publishedDate,
          specifiedType: const FullType(String)),
      'alertMessage',
      serializers.serialize(object.alertMessage,
          specifiedType: const FullType(String)),
    ];
  ...
  @override
  TravelAlert deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new TravelAlertBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'publishedDate':
          ...
          break;
        case 'alertMessage':
          result.alertMessage = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
      }
    }
...
class _$StatsCounter extends StatsCounter {
  ...
  _$StatsCounter._(
      {this.country, this.numConfirm, this.numDead, this.numHeal, this.created})
      : super._() {
    if (numConfirm == null) {
...
class _$TravelAlert extends TravelAlert {
  @override
  ...
  factory _$TravelAlert([void Function(TravelAlertBuilder) updates]) =>
      (new TravelAlertBuilder()..update(updates)).build();
  ...
  _$TravelAlert._(
      ...
      : super._() {
    if (countryCode == null) {
      throw new BuiltValueNullFieldError('TravelAlert', 'countryCode');
    }
    if (countryName == null) {
      throw new BuiltValueNullFieldError('TravelAlert', 'countryName');
    }
    if (publishedDate == null) {
      throw new BuiltValueNullFieldError('TravelAlert', 'publishedDate');
    }
    if (alertMessage == null) {
      throw new BuiltValueNullFieldError('TravelAlert', 'alertMessage');
    }
  }

  @override
  TravelAlert rebuild(void Function(TravelAlertBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TravelAlertBuilder toBuilder() => new TravelAlertBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TravelAlert &&
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, countryCode.hashCode), countryName.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('TravelAlert')
...
class TravelAlertBuilder implements Builder<TravelAlert, TravelAlertBuilder> {
  _$TravelAlert _$v;
  ...
  @override
  void replace(TravelAlert other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$TravelAlert;
  }

  @override
  void update(void Function(TravelAlertBuilder) updates) {
    if (updates != null) updates(this);
  }
